...
\begin{itemize}
  ...
  \item 负责核心系统高风险需求落地，协调上下游排期与联调，核心需求按期交付率 \textbf{100\%}
  \item 构建\textbf{可灰度、可监控、可回滚}的发布体系（核心接口灰度能力、Prometheus+Grafana 监控），建设核心系统双活能力，通过性能调优降低核心系统资源占用，保证大促期间系统稳定运行
\end{itemize}
\end{onehalfspacing}
